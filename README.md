...
There is another file [`NonModernCMake.md`](NonModernCMake.md) with other links worth taking a look, but they use obsolete practices which are considered non-modern - like not using `target_*`-based dependency management - see [`#16`](https://github.com/onqtam/awesome-cmake/issues/16) ⭐ 5,412 | 🐛 4 | 📅 2026-08-13 and [`#42`](https://github.com/onqtam/awesome-cmake/pull/42) ⭐ 5,412 | 🐛 4 | 📅 2026-08-13 for more details.
...
* [Web Book](https://github.com/ruslo/CGold) ⭐ 535 | 🐛 25 | 📅 2023-06-05 - CGold: The Hitchhiker’s [Guide](https://cgold.readthedocs.io) to the CMake. [`[BSD2]`][BSD-2-Clause]
* [Modern CMake](https://github.com/toeb/moderncmake) ⭐ 246 | 🐛 2 | 🌐 CMake | 📅 2016-08-31 - Modern CMake **PDF** and samples by the creator of [cmakepp](https://github.com/toeb/cmakepp) ⭐ 448 | 🐛 40 | 🌐 CMake | 📅 2021-12-27. [`[MIT]`][MIT]
...
* [vcpkg](https://github.com/Microsoft/vcpkg) ⭐ 27,357 | 🐛 1,181 | 🌐 CMake | 📅 2026-08-14 - A tool to acquire and build C++ open source libraries. Uses CMake internally as a build script language. [`[MIT]`][MIT]
* [Ninja](https://github.com/ninja-build/ninja) ⭐ 13,143 | 🐛 414 | 🌐 C++ | 📅 2026-07-25 - Build system that differs from others in two major respects: it is designed to have its input files generated by a higher-level build system (like CMake), and it is designed to run builds as fast as possible. [`[APACHE2]`][APACHE2]
* [conan](https://github.com/conan-io/conan) ⭐ 9,480 | 🐛 487 | 🌐 Python | 📅 2026-08-14 - Conan C++ Package Manager, implemented in Python and has a CMake integration backend. [`[MIT]`][MIT]
* [cpm](https://github.com/TheLartians/CPM) ⭐ 4,091 | 🐛 164 | 🌐 CMake | 📅 2026-07-06 - A setup-free CMake + git dependency manager. [`[MIT]`][MIT]
...
* [cpm](https://github.com/iauns/cpm) ⭐ 751 | 🐛 14 | 🌐 CMake | 📅 2021-08-28 - C++ Package Manager based on CMake and Git. [`[MIT]`][MIT]
* [fips](https://github.com/floooh/fips) ⭐ 505 | 🐛 58 | 🌐 Python | 📅 2026-01-26 - High-level build system/dependency management for distributed, multi-platform C/C++ projects. [`[MIT]`][MIT]
* [cget](https://github.com/pfultz2/cget) ⭐ 464 | 🐛 51 | 🌐 Python | 📅 2026-07-14 - CMake package retrieval. This can be used to download and install CMake packages. [`[BOOST]`][BOOST]
...
* [cmake-modules](https://github.com/rpavlik/cmake-modules) ⭐ 1,072 | 🐛 19 | 🌐 CMake | 📅 2025-02-10 - [Ryan Pavlik](https://github.com/rpavlik)'s collection of CMake modules. There are a number of find modules, especially for virtual reality and physical simulation, some utility modules, and some patches or workarounds for CMake itself. [`[BOOST]`][BOOST]
* [cmake-modules](https://github.com/bilke/cmake-modules) ⭐ 593 | 🐛 31 | 🌐 CMake | 📅 2026-03-25 - This is a collection of additional CMake modules. Most of them are from Ryan Pavlik. [`[BOOST]`][BOOST]
...
* [extra-cmake-modules](https://github.com/KDE/extra-cmake-modules) ⭐ 154 | 🐛 0 | 🌐 CMake | 📅 2026-08-14 - [KDE](https://github.com/KDE)'s extra modules and scripts for CMake. [`[BSD3]`][BSD-3-Clause]
...
* [YCM](https://github.com/robotology/ycm) ⭐ 63 | 🐛 50 | 🌐 CMake | 📅 2026-07-24 - Extra CMake Modules for [Yet Another Robot Platform](https://github.com/robotology/yarp) ⭐ 601 | 🐛 249 | 🌐 C++ | 📅 2026-08-14 and friends. [`[BSD3]`][BSD-3-Clause]
...
* [sanitizers-cmake](https://github.com/arsenm/sanitizers-cmake) ⭐ 412 | 🐛 12 | 🌐 CMake | 📅 2025-11-04 - CMake module to enable sanitizers for binary targets. [`[MIT]`][MIT]
...
* [cmake-unit](https://github.com/polysquare/cmake-unit) ⭐ 39 | 🐛 4 | 🌐 CMake | 📅 2017-05-31 - Unit testing framework for CMake. [`[MIT]`][MIT]
...
* [dockcross](https://github.com/dockcross/dockcross) ⭐ 3,605 | 🐛 9 | 🌐 Shell | 📅 2026-07-30 - Cross compiling toolchains in Docker images. [`[MIT]`][MIT]
...
* [qt-android-cmake](https://github.com/LaurentGomila/qt-android-cmake) ⭐ 251 | 🐛 4 | 🌐 CMake | 📅 2022-05-09 - For building and deploying Qt based apps on Android without QtCreator. [`[LICENSE]`](https://github.com/LaurentGomila/qt-android-cmake/blob/master/license.txt) ⭐ 251 | 🐛 4 | 🌐 CMake | 📅 2022-05-09
* [cmake-avr](https://github.com/mkleemann/cmake-avr) ⭐ 185 | 🐛 9 | 🌐 CMake | 📅 2022-04-17 - CMake toolchain for AVR. [`[LICENSE]`](https://github.com/mkleemann/cmake-avr/blob/master/LICENSE) ⭐ 185 | 🐛 9 | 🌐 CMake | 📅 2022-04-17
...
* [toolchains](https://github.com/mosra/toolchains) ⭐ 96 | 🐛 2 | 🌐 CMake | 📅 2026-07-16 - For cross-compiling with CMake. They are meant to be mainly used on ArchLinux. `[NO LICENSE]`
...
* [cmake-examples](https://github.com/ttroy50/cmake-examples) ⭐ 13,070 | 🐛 30 | 🌐 CMake | 📅 2024-02-28 - Useful CMake examples in a tutorial format. [`[MIT]`][MIT]
* [ModernCppStarter](https://github.com/TheLartians/ModernCppStarter) ⭐ 5,386 | 🐛 26 | 🌐 CMake | 📅 2026-05-30 - A template for modern C++ projects using CMake, CI, code coverage, clang-format, reproducible dependency management, tests using [doctest](https://github.com/onqtam/doctest) ⭐ 6,844 | 🐛 139 | 🌐 C++ | 📅 2026-07-12 and much more. [`[UNLICENSE]`][UNLICENSE]
* [cmake-cookbook](https://github.com/dev-cafe/cmake-cookbook) ⭐ 2,850 | 🐛 28 | 🌐 C++ | 📅 2021-06-01 - A huge CMake cookbook full of recipes. [`[MIT]`][MIT]
* [pitchfork](https://github.com/vector-of-bool/pitchfork) ⭐ 1,253 | 🐛 42 | 🌐 C++ | 📅 2024-04-26 - A set of conventions for native C and C++ projects. [`[MIT]`][MIT]
* [cmake-examples](https://github.com/pr0g/cmake-examples) ⭐ 1,236 | 🐛 1 | 🌐 CMake | 📅 2025-02-22 - A collection of as simple as possible, modern CMake projects. [`[MIT]`][MIT]
...
* [how-to-export-cpp-library](https://github.com/robotology/how-to-export-cpp-library) ⭐ 375 | 🐛 12 | 🌐 CMake | 📅 2021-01-13 - An OS-agnostic template project for exporting either shared, static or header-only C++ library, sporting ctest and CI support, written in plain CMake with line-by-line tutorial comments. [`[MIT]`][MIT]
...
* [CMakeInstallExample](https://github.com/DeveloperPaul123/CMakeInstallExample) ⭐ 39 | 🐛 0 | 🌐 CMake | 📅 2021-09-07 - Installation example for a C++ project (Windows) with Cmake. `[NO LICENSE]`
...
* [scikit-build](https://github.com/scikit-build/scikit-build) ⭐ 535 | 🐛 5 | 🌐 Python | 📅 2026-08-14 - Improved build system generator for CPython C extensions. [`[MIT]`][MIT]
...
* [cmake-language-server](https://github.com/regen100/cmake-language-server) ⭐ 407 | 🐛 24 | 🌐 Python | 📅 2025-02-11 - CMake Language Server Protocol Implementation. [`[MIT]`][MIT]
...
* [osg-3rdparty-cmake](https://github.com/bjornblissing/osg-3rdparty-cmake) ⭐ 200 | 🐛 10 | 🌐 CMake | 📅 2023-01-12 - CMake scripts for building OpenSceneGraph third party libraries. `[MIXED LICENSE]`
...
* [git-cmake-format](https://github.com/kbenzie/git-cmake-format) ⭐ 60 | 🐛 2 | 🌐 CMake | 📅 2017-10-24 - Integrate clang-format into your CMake project hosted in a git repository. [`[LICENSE]`](https://github.com/kbenzie/git-cmake-format/blob/master/license.txt) ⭐ 60 | 🐛 2 | 🌐 CMake | 📅 2017-10-24
* [cmake-font-lock](https://github.com/Lindydancer/cmake-font-lock) ⭐ 48 | 🐛 6 | 🌐 CMake | 📅 2024-04-18 - Advanced syntax coloring support for CMake scripts inside Emacs. [`[GPL]`][GPL]
...
* [SoCMake](https://github.com/HEP-SoC/SoCMake) ⭐ 44 | 🐛 22 | 🌐 CMake | 📅 2026-08-13 - CMake based build system for hardware (ASIC, FPGA) and System-on-Chip build automation. [`[LGPL]`][LGPL]
...
* [cmakefmt](https://github.com/cmakefmt/cmakefmt) ⭐ 19 | 🐛 33 | 🌐 Rust | 📅 2026-08-10 - Fast, native CMake formatter written in Rust with format-on-save editor support and a first-party GitHub Action. [`[MIT]`][MIT]
