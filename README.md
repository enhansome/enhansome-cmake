...
There is another file [`NonModernCMake.md`](NonModernCMake.md) with other links worth taking a look, but they use obsolete practices which are considered non-modern - like not using `target_*`-based dependency management - see [`#16`](https://github.com/onqtam/awesome-cmake/issues/16) ⭐ 5,415 | 🐛 4 | 📅 2026-08-13 and [`#42`](https://github.com/onqtam/awesome-cmake/pull/42) ⭐ 5,415 | 🐛 4 | 📅 2026-08-13 for more details.
...
* [vcpkg](https://github.com/Microsoft/vcpkg) ⭐ 27,369 | 🐛 1,143 | 🌐 CMake | 📅 2026-08-17 - A tool to acquire and build C++ open source libraries. Uses CMake internally as a build script language. [`[MIT]`][MIT]
* [Ninja](https://github.com/ninja-build/ninja) ⭐ 13,150 | 🐛 415 | 🌐 C++ | 📅 2026-07-25 - Build system that differs from others in two major respects: it is designed to have its input files generated by a higher-level build system (like CMake), and it is designed to run builds as fast as possible. [`[APACHE2]`][APACHE2]
* [conan](https://github.com/conan-io/conan) ⭐ 9,484 | 🐛 485 | 🌐 Python | 📅 2026-08-17 - Conan C++ Package Manager, implemented in Python and has a CMake integration backend. [`[MIT]`][MIT]
* [cpm](https://github.com/TheLartians/CPM) ⭐ 4,094 | 🐛 164 | 🌐 CMake | 📅 2026-07-06 - A setup-free CMake + git dependency manager. [`[MIT]`][MIT]
...
* [YCM](https://github.com/robotology/ycm) ⭐ 63 | 🐛 50 | 🌐 CMake | 📅 2026-07-24 - Extra CMake Modules for [Yet Another Robot Platform](https://github.com/robotology/yarp) ⭐ 602 | 🐛 251 | 🌐 C++ | 📅 2026-08-17 and friends. [`[BSD3]`][BSD-3-Clause]
...
* [cmake-examples](https://github.com/ttroy50/cmake-examples) ⭐ 13,074 | 🐛 30 | 🌐 CMake | 📅 2024-02-28 - Useful CMake examples in a tutorial format. [`[MIT]`][MIT]
* [ModernCppStarter](https://github.com/TheLartians/ModernCppStarter) ⭐ 5,388 | 🐛 25 | 🌐 CMake | 📅 2026-05-30 - A template for modern C++ projects using CMake, CI, code coverage, clang-format, reproducible dependency management, tests using [doctest](https://github.com/onqtam/doctest) ⭐ 6,845 | 🐛 139 | 🌐 C++ | 📅 2026-07-12 and much more. [`[UNLICENSE]`][UNLICENSE]
* [cmake-cookbook](https://github.com/dev-cafe/cmake-cookbook) ⭐ 2,849 | 🐛 28 | 🌐 C++ | 📅 2021-06-01 - A huge CMake cookbook full of recipes. [`[MIT]`][MIT]
...
* [scikit-build](https://github.com/scikit-build/scikit-build) ⭐ 535 | 🐛 1 | 🌐 Python | 📅 2026-08-17 - Improved build system generator for CPython C extensions. [`[MIT]`][MIT]
