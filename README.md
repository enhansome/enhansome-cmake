...
* [vcpkg](https://github.com/Microsoft/vcpkg) ⭐ 27,395 | 🐛 1,177 | 🌐 CMake | 📅 2026-08-25 - A tool to acquire and build C++ open source libraries. Uses CMake internally as a build script language. [`[MIT]`][MIT]
* [Ninja](https://github.com/ninja-build/ninja) ⭐ 13,164 | 🐛 417 | 🌐 C++ | 📅 2026-07-25 - Build system that differs from others in two major respects: it is designed to have its input files generated by a higher-level build system (like CMake), and it is designed to run builds as fast as possible. [`[APACHE2]`][APACHE2]
* [conan](https://github.com/conan-io/conan) ⭐ 9,493 | 🐛 486 | 🌐 Python | 📅 2026-08-25 - Conan C++ Package Manager, implemented in Python and has a CMake integration backend. [`[MIT]`][MIT]
...
* [YCM](https://github.com/robotology/ycm) ⭐ 63 | 🐛 50 | 🌐 CMake | 📅 2026-07-24 - Extra CMake Modules for [Yet Another Robot Platform](https://github.com/robotology/yarp) ⭐ 602 | 🐛 252 | 🌐 C++ | 📅 2026-08-25 and friends. [`[BSD3]`][BSD-3-Clause]
...
* [modern-cmake-sample](https://github.com/pabloariasal/modern-cmake-sample) ⭐ 673 | 🐛 5 | 🌐 CMake | 📅 2021-03-18 - Best practices and proper usage of CMake by using targets. `[NO LICENSE]`
