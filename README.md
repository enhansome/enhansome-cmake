...
There is another file [`NonModernCMake.md`](NonModernCMake.md) with other links worth taking a look, but they use obsolete practices which are considered non-modern - like not using `target_*`-based dependency management - see [`#16`](https://github.com/onqtam/awesome-cmake/issues/16) ⭐ 5,417 | 🐛 4 | 📅 2026-08-13 and [`#42`](https://github.com/onqtam/awesome-cmake/pull/42) ⭐ 5,417 | 🐛 4 | 📅 2026-08-13 for more details.
...
* [Modern CMake](https://github.com/toeb/moderncmake) ⭐ 245 | 🐛 2 | 🌐 CMake | 📅 2016-08-31 - Modern CMake **PDF** and samples by the creator of [cmakepp](https://github.com/toeb/cmakepp) ⭐ 448 | 🐛 40 | 🌐 CMake | 📅 2021-12-27. [`[MIT]`][MIT]
* [Lecture](https://www.youtube.com/watch?v=y7ndUhdQuU8) - More Modern CMake ([slides & examples](https://github.com/Bagira80/More-Modern-CMake) ⭐ 170 | 🐛 0 | 🌐 CMake | 📅 2020-02-11)- by Deniz Bahadir, Meeting C++ 2018.
* [Lecture](https://www.youtube.com/watch?v=y9kSr5enrSk) - Oh No! More Modern CMake ([slides](https://github.com/Bagira80/More-Modern-CMake/raw/master/OhNoMoreModernCMake.pdf) ⭐ 170 | 🐛 0 | 🌐 CMake | 📅 2020-02-11)- by Deniz Bahadir, Meeting C++ 2019.
...
* [vcpkg](https://github.com/Microsoft/vcpkg) ⭐ 27,485 | 🐛 1,098 | 🌐 CMake | 📅 2026-09-25 - A tool to acquire and build C++ open source libraries. Uses CMake internally as a build script language. [`[MIT]`][MIT]
* [Ninja](https://github.com/ninja-build/ninja) ⭐ 13,264 | 🐛 408 | 🌐 C++ | 📅 2026-09-24 - Build system that differs from others in two major respects: it is designed to have its input files generated by a higher-level build system (like CMake), and it is designed to run builds as fast as possible. [`[APACHE2]`][APACHE2]
* [conan](https://github.com/conan-io/conan) ⭐ 9,528 | 🐛 476 | 🌐 Python | 📅 2026-09-25 - Conan C++ Package Manager, implemented in Python and has a CMake integration backend. [`[MIT]`][MIT]
* [cpm](https://github.com/TheLartians/CPM) ⭐ 4,132 | 🐛 166 | 🌐 CMake | 📅 2026-09-24 - A setup-free CMake + git dependency manager. [`[MIT]`][MIT]
...
* [cget](https://github.com/pfultz2/cget) ⭐ 463 | 🐛 51 | 🌐 Python | 📅 2026-07-14 - CMake package retrieval. This can be used to download and install CMake packages. [`[BOOST]`][BOOST]
* [pmm](https://github.com/AnotherFoxGuy/pmm) ⭐ 17 | 🐛 6 | 🌐 CMake | 📅 2026-08-30 - PMM is a module for CMake that manages... package managers. [`[MIT]`][MIT]
* [FetchDependency](https://github.com/jpetrie/fetch-dependency) ⭐ 4 | 🐛 0 | 🌐 CMake | 📅 2026-05-04 - Configuration-time retrieval, configuration and building of dependencies. [`[MIT]`][MIT]
* [cppan](https://cppan.org/) - C++ Archive Network - C++ Package Manager based on CMake, implemented in C++14. [`[APACHE2]`][APACHE2]

## Modules

* [cmake-modules](https://github.com/rpavlik/cmake-modules) ⭐ 1,070 | 🐛 19 | 🌐 CMake | 📅 2025-02-10 - [Ryan Pavlik](https://github.com/rpavlik)'s collection of CMake modules. There are a number of find modules, especially for virtual reality and physical simulation, some utility modules, and some patches or workarounds for CMake itself. [`[BOOST]`][BOOST]
* [cmake-modules](https://github.com/bilke/cmake-modules) ⭐ 592 | 🐛 31 | 🌐 CMake | 📅 2026-03-25 - This is a collection of additional CMake modules. Most of them are from Ryan Pavlik. [`[BOOST]`][BOOST]
* [Metabench](https://github.com/ldionne/metabench) ⭐ 189 | 🐛 12 | 🌐 CMake | 📅 2021-05-01 - CMake module for compile-time microbenchmarks. [`[BOOST]`][BOOST]
* [extra-cmake-modules](https://github.com/KDE/extra-cmake-modules) ⭐ 154 | 🐛 0 | 🌐 CMake | 📅 2026-09-11 - [KDE](https://github.com/KDE)'s extra modules and scripts for CMake. [`[BSD3]`][BSD-3-Clause]
* [CMake](https://github.com/Eyescale/CMake) ⭐ 153 | 🐛 13 | 🌐 CMake | 📅 2023-12-05 - [Eyescale](https://github.com/Eyescale)'s common CMake modules. [`[BSD3]`][BSD-3-Clause]
* [cgcmake](https://github.com/chadmv/cgcmake) ⭐ 133 | 🐛 1 | 🌐 CMake | 📅 2021-06-08 - CMake modules for common applications related to computer graphics. [`[MIT]`][MIT]
...
* [YCM](https://github.com/robotology/ycm) ⭐ 63 | 🐛 50 | 🌐 CMake | 📅 2026-07-24 - Extra CMake Modules for [Yet Another Robot Platform](https://github.com/robotology/yarp) ⭐ 603 | 🐛 250 | 🌐 C++ | 📅 2026-09-24 and friends. [`[BSD3]`][BSD-3-Clause]
...
* [CMakeCM](https://github.com/AnotherFoxGuy/CMakeCM) ⭐ 2 | 🐛 2 | 🌐 CMake | 📅 2026-08-30 - CMake Community Modules. `[NO LICENSE]`
...
* [cmakepp](https://github.com/toeb/cmakepp) ⭐ 448 | 🐛 40 | 🌐 CMake | 📅 2021-12-27 - Enhancement Suite for the CMake Build System. [`[MIT]`][MIT]
...
* [sanitizers-cmake](https://github.com/arsenm/sanitizers-cmake) ⭐ 413 | 🐛 12 | 🌐 CMake | 📅 2025-11-04 - CMake module to enable sanitizers for binary targets. [`[MIT]`][MIT]
* [ucm](https://github.com/onqtam/ucm) ⭐ 214 | 🐛 4 | 🌐 CMake | 📅 2023-03-13 - For managing compiler/linker flags, collecting sources, precompiled headers, unity builds and others. [`[MIT]`][MIT]
* [cmake-precompiled-header](https://github.com/larsch/cmake-precompiled-header) ⭐ 162 | 🐛 19 | 🌐 CMake | 📅 2019-11-01 - Visual Studio and GCC precompiled header macro. [`[LICENSE]`](https://github.com/larsch/cmake-precompiled-header/blob/master/PrecompiledHeader.cmake#L31) ⭐ 162 | 🐛 19 | 🌐 CMake | 📅 2019-11-01
...
* [CMakePCHCompiler](https://github.com/nanoant/CMakePCHCompiler) ⭐ 102 | 🐛 9 | 🌐 CMake | 📅 2019-10-26 - CMake precompiled headers via custom compiler extension - with reuse support! [`[MIT]`][MIT]
...
* [CMake-codecov](https://github.com/RWTH-ELP/CMake-codecov) ⭐ 98 | 🐛 6 | 🌐 CMake | 📅 2026-04-03 - Enables code coverage and generates coverage reports with CMake targets. [`[GPL]`][GPL]
...
* [dockcross](https://github.com/dockcross/dockcross) ⭐ 3,612 | 🐛 8 | 🌐 Shell | 📅 2026-09-06 - Cross compiling toolchains in Docker images. [`[MIT]`][MIT]
* [android-cmake](https://github.com/taka-no-me/android-cmake) ⭐ 1,228 | 🐛 45 | 🌐 CMake | 📅 2018-02-16 - CMake toolchain file and other scripts for the Android NDK. [`[BSD3]`][BSD-3-Clause]
...
* [ios-cmake](https://github.com/cristeab/ios-cmake) ⭐ 316 | 🐛 1 | 🌐 CMake | 📅 2020-09-02 - Toolchain file and examples using CMake for iOS development. [`[BSD3]`][BSD-3-Clause]
...
* [cmake-avr](https://github.com/mkleemann/cmake-avr) ⭐ 183 | 🐛 9 | 🌐 CMake | 📅 2022-04-17 - CMake toolchain for AVR. [`[LICENSE]`](https://github.com/mkleemann/cmake-avr/blob/master/LICENSE) ⭐ 183 | 🐛 9 | 🌐 CMake | 📅 2022-04-17
* [Arduino-CMake-Toolchain](https://github.com/a9183756-gh/Arduino-CMake-Toolchain) ⭐ 150 | 🐛 24 | 🌐 CMake | 📅 2023-02-24 - CMake toolchain for all official and 3rd party Arduino platforms. [`[MIT]`][MIT]
* [toolchains](https://github.com/mosra/toolchains) ⭐ 97 | 🐛 2 | 🌐 CMake | 📅 2026-07-16 - For cross-compiling with CMake. They are meant to be mainly used on ArchLinux. `[NO LICENSE]`
...
* [cmake-examples](https://github.com/ttroy50/cmake-examples) ⭐ 13,065 | 🐛 30 | 🌐 CMake | 📅 2024-02-28 - Useful CMake examples in a tutorial format. [`[MIT]`][MIT]
* [ModernCppStarter](https://github.com/TheLartians/ModernCppStarter) ⭐ 5,408 | 🐛 25 | 🌐 CMake | 📅 2026-05-30 - A template for modern C++ projects using CMake, CI, code coverage, clang-format, reproducible dependency management, tests using [doctest](https://github.com/onqtam/doctest) ⭐ 6,871 | 🐛 142 | 🌐 C++ | 📅 2026-08-29 and much more. [`[UNLICENSE]`][UNLICENSE]
* [cmake-cookbook](https://github.com/dev-cafe/cmake-cookbook) ⭐ 2,846 | 🐛 28 | 🌐 C++ | 📅 2021-06-01 - A huge CMake cookbook full of recipes. [`[MIT]`][MIT]
* [pitchfork](https://github.com/vector-of-bool/pitchfork) ⭐ 1,257 | 🐛 42 | 🌐 C++ | 📅 2024-04-26 - A set of conventions for native C and C++ projects. [`[MIT]`][MIT]
* [cmake-examples](https://github.com/pr0g/cmake-examples) ⭐ 1,237 | 🐛 1 | 🌐 CMake | 📅 2025-02-22 - A collection of as simple as possible, modern CMake projects. [`[MIT]`][MIT]
* [cmake-init](https://github.com/cginternals/cmake-init) ⭐ 941 | 🐛 24 | 🌐 CMake | 📅 2026-08-04 - Template for reliable, cross-platform C++ project setup using CMake. [`[LICENSE]`](https://github.com/cginternals/cmake-init/blob/master/LICENSE) ⭐ 941 | 🐛 24 | 🌐 CMake | 📅 2026-08-04
* [modern-cmake-sample](https://github.com/pabloariasal/modern-cmake-sample) ⭐ 673 | 🐛 6 | 🌐 CMake | 📅 2021-03-18 - Best practices and proper usage of CMake by using targets. `[NO LICENSE]`
* [cpp-project](https://github.com/bsamseth/cpp-project) ⭐ 625 | 🐛 2 | 🌐 CMake | 📅 2023-09-19 - Boiler plate for C++ projects - tests, CI, coverage, docs. [`[UNLICENSE]`][UNLICENSE]
...
* [how-to-export-cpp-library](https://github.com/robotology/how-to-export-cpp-library) ⭐ 374 | 🐛 12 | 🌐 CMake | 📅 2021-01-13 - An OS-agnostic template project for exporting either shared, static or header-only C++ library, sporting ctest and CI support, written in plain CMake with line-by-line tutorial comments. [`[MIT]`][MIT]
* [cpp-boilerplate](https://github.com/Lectem/cpp-boilerplate) ⭐ 331 | 🐛 1 | 🌐 CMake | 📅 2025-08-06 - Template that aims to be a reference for modern CMake and CI. [`[MIT]`][MIT]
* [mini-cmake-qt](https://github.com/euler0/mini-cmake-qt) ⭐ 221 | 🐛 1 | 🌐 CMake | 📅 2025-08-05 - Minimal CMake template for Qt 5 projects. [`[LICENSE]`](https://github.com/euler0/mini-cmake-qt/blob/master/LICENSE) ⭐ 221 | 🐛 1 | 🌐 CMake | 📅 2025-08-05
...
* [cmake-example](https://github.com/bast/cmake-example) ⭐ 145 | 🐛 1 | 🌐 CMake | 📅 2021-02-04 - Example project which demonstrates various CMake features. [`[BSD3]`][BSD-3-Clause]
* [cmake\_templates](https://github.com/acdemiralp/cmake_templates) ⭐ 131 | 🐛 1 | 🌐 CMake | 📅 2026-08-01 - Templates for creating C++ libraries and executables (including conan). `[NO LICENSE]`
...
* [cpp-template](https://github.com/joshpeterson/cpp-template) ⭐ 54 | 🐛 0 | 🌐 Python | 📅 2022-05-30 - A template C++ repository, using CMake and Catch. `[NO LICENSE]`
...
* [CMakeInstallExample](https://github.com/DeveloperPaul123/CMakeInstallExample) ⭐ 40 | 🐛 0 | 🌐 CMake | 📅 2021-09-07 - Installation example for a C++ project (Windows) with Cmake. `[NO LICENSE]`
...
* [SeeMake](https://github.com/MhmRhm/SeeMake) ⭐ 13 | 🐛 0 | 🌐 CMake | 📅 2026-07-05 - A feature-packed, ready-to-use CMake template with testing, static and dynamic checks, coverage reports, and more. [`[MIT]`][MIT]

## Other

* [scikit-build](https://github.com/scikit-build/scikit-build) ⭐ 534 | 🐛 2 | 🌐 Python | 📅 2026-09-07 - Improved build system generator for CPython C extensions. [`[MIT]`][MIT]
...
* [cmake-language-server](https://github.com/regen100/cmake-language-server) ⭐ 409 | 🐛 24 | 🌐 Python | 📅 2025-02-11 - CMake Language Server Protocol Implementation. [`[MIT]`][MIT]
...
* [osg-3rdparty-cmake](https://github.com/bjornblissing/osg-3rdparty-cmake) ⭐ 200 | 🐛 2 | 🌐 CMake | 📅 2023-01-12 - CMake scripts for building OpenSceneGraph third party libraries. `[MIXED LICENSE]`
...
* [cmake-checks-cache](https://github.com/cristianadam/cmake-checks-cache) ⭐ 90 | 🐛 2 | 🌐 CMake | 📅 2022-03-04 - CMake checks cache helper modules. [`[MIT]`][MIT]
...
* [cmake-maven-plugin](https://github.com/cmake-maven-project/cmake-maven-project) ⭐ 83 | 🐛 0 | 🌐 Java | 📅 2026-02-24 - CMake integration for Maven builds. [`[APACHE2]`][APACHE2]
...
* [cmake-d](https://github.com/dcarp/cmake-d) ⭐ 67 | 🐛 4 | 🌐 CMake | 📅 2023-06-09 - CMake for D2. [`[MIT]`][MIT]
* [git-cmake-format](https://github.com/kbenzie/git-cmake-format) ⭐ 61 | 🐛 2 | 🌐 CMake | 📅 2017-10-24 - Integrate clang-format into your CMake project hosted in a git repository. [`[LICENSE]`](https://github.com/kbenzie/git-cmake-format/blob/master/license.txt) ⭐ 61 | 🐛 2 | 🌐 CMake | 📅 2017-10-24
...
* [cmakefmt](https://github.com/cmakefmt/cmakefmt) ⭐ 24 | 🐛 32 | 🌐 Rust | 📅 2026-08-31 - Fast, native CMake formatter written in Rust with format-on-save editor support and a first-party GitHub Action. [`[MIT]`][MIT]
...
* [version-from-git](https://github.com/MhmRhm/version-from-git) ⭐ 7 | 🐛 0 | 🌐 CMake | 📅 2022-05-04 - Bake git information into your binary. [`[MIT]`][MIT]
* [cmake-xray](https://github.com/pt9912/cmake-xray) ⭐ 2 | 🐛 0 | 🌐 C++ | 📅 2026-06-12 - Analyze and diagnose CMake-based C++ builds from compile databases and CMake File API data. [`[MIT]`][MIT]
