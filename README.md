...
* [vcpkg](https://github.com/Microsoft/vcpkg) ⭐ 27,356 | 🐛 1,163 | 🌐 CMake | 📅 2026-08-13 - A tool to acquire and build C++ open source libraries. Uses CMake internally as a build script language. [`[MIT]`][MIT]
* [Ninja](https://github.com/ninja-build/ninja) ⭐ 13,141 | 🐛 414 | 🌐 C++ | 📅 2026-07-25 - Build system that differs from others in two major respects: it is designed to have its input files generated by a higher-level build system (like CMake), and it is designed to run builds as fast as possible. [`[APACHE2]`][APACHE2]
* [conan](https://github.com/conan-io/conan) ⭐ 9,478 | 🐛 486 | 🌐 Python | 📅 2026-08-13 - Conan C++ Package Manager, implemented in Python and has a CMake integration backend. [`[MIT]`][MIT]
* [cpm](https://github.com/TheLartians/CPM) ⭐ 4,089 | 🐛 164 | 🌐 CMake | 📅 2026-07-06 - A setup-free CMake + git dependency manager. [`[MIT]`][MIT]
...
* [extra-cmake-modules](https://github.com/KDE/extra-cmake-modules) ⭐ 154 | 🐛 0 | 🌐 CMake | 📅 2026-08-12 - [KDE](https://github.com/KDE)'s extra modules and scripts for CMake. [`[BSD3]`][BSD-3-Clause]
...
* [YCM](https://github.com/robotology/ycm) ⭐ 63 | 🐛 50 | 🌐 CMake | 📅 2026-07-24 - Extra CMake Modules for [Yet Another Robot Platform](https://github.com/robotology/yarp) ⭐ 600 | 🐛 249 | 🌐 C++ | 📅 2026-08-13 and friends. [`[BSD3]`][BSD-3-Clause]
...
* [dockcross](https://github.com/dockcross/dockcross) ⭐ 3,604 | 🐛 9 | 🌐 Shell | 📅 2026-07-30 - Cross compiling toolchains in Docker images. [`[MIT]`][MIT]
* [android-cmake](https://github.com/taka-no-me/android-cmake) ⭐ 1,229 | 🐛 45 | 🌐 CMake | 📅 2018-02-16 - CMake toolchain file and other scripts for the Android NDK. [`[BSD3]`][BSD-3-Clause]
...
* [scikit-build](https://github.com/scikit-build/scikit-build) ⭐ 535 | 🐛 8 | 🌐 Python | 📅 2026-08-10 - Improved build system generator for CPython C extensions. [`[MIT]`][MIT]
